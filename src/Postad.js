...
class Postad extends Component {
    ...
    onSubmitAd = (e) => {
        ...
        let catogary = document.getElementById('category').value;


        let filesSelected = document.getElementById("itemPic").files;
        let user = document.getElementById('userName').value;
        let sellerEmail = document.getElementById("userEmail").value;
        let sellerPhone = document.getElementById('userPhone').value;
        ...
        if (filesSelected.length > 0) {
            ...
            fileReader.onload = function (fileLoadedEvent) {
                ...
                axios({
                    ...
                    url: '/user/add',
                    data: {
                        adTitle, itemCondition, itemPic, price, city, itemDetails,sellerEmail,
                        catogary, user,sellerPhone
                    }
    ...
    render() {
        ...
        return (
            <div className="addForm">
                ...
                <div className="container" id='postAdMain' style={{ border: "1px solid red" }}>
                    {/* <Header history={this.props.history} /> */}
                    <div>
                        <ToastContainer />
                    </div>
                    <div className='row '>
                        <form className='formBody2' onSubmit={this.onSubmitAd}>
                            <div className="row">
                                <div className="col-md-2"></div>
                                <div className="form-group col-md-6 ">
                                    <label htmlFor="adTitle" className="paddings">Ad Title</label>
                                    <input type="text" className="form-control adTitle" id="adTitle" placeholder="Ad Title" required />
                                </div>
                                </div>
                                <div className="row">
                                    <div className="col-md-2"></div>
                                        <div className="form-group col-md-6">
                                            ...
                                            <select className="custom-select adTitle " id='condition' required>
                                                <option value="1/10" defaultValue>One By Ten</option>
                                                <option value="2/10">Two By Ten</option>
                                                <option value="3/10">Three By Ten</option>
                                                <option value="4/10">Four By Ten</option>
                                                <option value="5/10">Five By Ten</option>
                                                <option value="6/10">Six By Ten</option>
                                                <option value="7/10">Seven By Ten</option>
                                                <option value="8/10">Eight By Ten</option>
                                                <option value="9/10">Nine By Ten</option>
                                                <option value="10/10">Ten By Ten</option>
                                            </select>
                                        </div>
                            ...
                            <div className = "col-md-2"></div>
                                <div className="form-group col-md-6">
                                    ...
                                    <select className="custom-select adTitle" id='category' required>
                                        <option value="Mobile" defaultValue>Mobile</option>
                                 ...
                                 <div className = "col-md-6">
                                    ...
                                    <input type="number" className="form-control  adTitle" id="price" required />
                                ...
                                {/* choose File */}
                                    ...
                                    <div className="custom-file">
                                        <input type="file" className="custom-file-input form-control adTitle" required onInput={this.handleFileInput} id="itemPic" />
                                ...
                                <textarea className="form-control " aria-label="With textarea" id='itemDetails' required></textarea>
                                    ...
                                    <div className = "col-md-3">
                                       <span style = {{marginTop:"5px", fontSize:"20px",color: "green", textAlign:"center"}}><b>Seller Information</b></span>
                                </div>
                                </div>
                                <div className="row">
                                <div className = "col-md-2"></div>
                                    <div className="col-md-6">
                                        <label htmlFor="Name" id='fileLabel'>Name</label>
                                        <input type="text" id="userName" className="form-control adTitle" placeholder="Enter Your Name" />
                                    </div>
                                </div>
                            ...
                            <div className="row">
                                <div className = "col-md-2"></div>
                                    <div className="col-md-6">
                                        <label htmlFor="Name" id='fileLabel2'>Email</label>
                                        <input type="text"  readOnly id="userEmail" className="form-control adTitle" placeholder="Enter Your Name" defaultValue = {this.state.email} />
                                    </div>
                                </div>
                                <div className="row">
                                <div className = "col-md-2"></div>
                                    <div className="col-md-6">
                                        <label htmlFor="Phone" id='fileLabel3'>Phone No</label>
                                        <input type="number" id="userPhone" className="form-control adTitle" placeholder="Enter Your Name" />
                                    </div>
                                </div>
                            

                            <button type="submit" className="btn btn-primary" id='sendBtn'>Post Ad</button>
                        </form>
                    </div>
